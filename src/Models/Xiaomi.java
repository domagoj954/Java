...
public class Xiaomi extends Phone implements Serializable {

    final double screenProtectionPrice = 5;
    final double maskPrice = 10;


    public Xiaomi(UUID uuid, String name, String OS, String color, int RAM, int internalMemory, int warranty, int battery, int frontCamera, int rearCamera, double price){
    ...
    public String toString(){
        return "Xiaomi{" + "UUID: " + uuid + " NAME: " + name + " OS: " + OS + " COLOR: " + color + " RAM: " + RAM + " INTERNAL MEMORY: "
